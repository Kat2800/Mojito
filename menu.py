...
try:
        ...
        network interfaces""")
                                ...
                                while True:
                                    ...
                                    if GPIO.input(KEY_UP_PIN) == 0:
                                        ...
                                        ui_print(f"""Selected Interface:{selected_option}""")
                        if selected_option == "Developer Options":
                            selected_index = 0
    ...
    print(f"[Error Handled] {e}. Restarting menu.")
    ...
    ui_print("Keyboard interrupt", 0.5)
    exit(0)  
